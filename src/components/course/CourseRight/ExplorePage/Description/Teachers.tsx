...
import { TeachersType } from '../../../../../../data/IndividualCourseDetails'
  ...
  return (
    <div className='h-max shadow-lg shadow-indigo-500/50 p-1 md:p-5 rounded-3xl mt-5 flex flex-col'>
      ...
      <div className={`overflow-x-scroll rounded-sm p-1 mt-4 ${styles.hide_scrollbar} `}>
        {
          teachers.map( (item) => (
            <div key={item.id} className='w-36 border p-1 flex flex-col shadow-md shadow-black/50'>
              <div className='relative h-40 w-32 bg-gray-100 mx-auto'>
                <Image src={item.image} alt="teacher" height={300} width={300} className='h-full w-full'/>
